...
test.describe('Pokemon Quiz', () => {
  ...
  test.describe('Station / Initial Load', () => {
    ...
    test.skip('Shows stable loading state while quiz data is delayed', async ({ page }) => {
      void page;
    });
    test.skip('Initial controls remain visible on mobile viewport', async ({ page }) => {
      void page;
    });
  });
  ...
  test.describe('Pool / Category Selection', () => {
    ...
    pokemonQuizTest('Type category starts a type question', async ({ page }) => {
      ...
      await expect(page.getByText('POKEMON TYPE')).toBeVisible();
      await expect(page.getByText(/WHAT TYPE IS/i)).toBeVisible();
      await expect(answerButtons(page)).toHaveCount(4);
    });

    test.skip('Each quiz category can start a question', async ({ page }) => {
      void page;
    });
    test.skip('Changing pool before start uses the most recent selected pool', async ({ page }) => {
      void page;
    });
    test.skip('Pool summary updates when a different Pokedex pool is selected', async ({
      page
    }) => {
      void page;
    });
  ...
  test.describe('Quiz Gameplay', () => {
    ...
    test.skip('Selecting an answer resolves the current question', async ({ page }) => {
      void page;
    });
  ...
  test.describe('Scoring', () => {
    ...
    test.skip('Correct answer increases score and streak', async ({ page }) => {
      void page;
    });
    test.skip('Wrong answer increments rounds without increasing score', async ({ page }) => {
      void page;
    });
    test.skip('Score and streak persist across multiple questions', async ({ page }) => {
      void page;
    });
  });
  ...
  test.describe('Edge / Reliability', () => {
    ...
    test.skip('Rapid answer clicks settle to one completed round', async ({ page }) => {
      void page;
    });
    test.skip('Image and audio request failures leave quiz controls usable', async ({ page }) => {
      void page;
    });
    test.skip('Delayed quiz data keeps stable loading or ready state', async ({ page }) => {
      void page;
    });
    test.skip('Changing category repeatedly before start leaves Start Quiz usable', async ({
      page
    }) => {
      void page;
    });
