...
| --------------------- | --------------------------------------- | ------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Pokemon Pokedex       | `tests/specs/pokedex.spec.ts`           | 44           | Initial load, paged Pokemon navigation, search, profiles, ability and move details, evolution navigation, sprite sets, game Pokedex filters including Legends Z-A, sorting, random Pokemon, image fallback, and rapid action reliability                                                                              |
| Pokemon TCG Simulator | `tests/specs/tcg-simulator.spec.ts`     | 46           | Session startup, pack opening, pack modal behavior, binder progress, collection clearing, bidirectional binder rarity sorting, unowned-card artwork display, set selection, Special / Limited reference sets, and search                                                                                              |
...
| Pokemon Team Planner  | `tests/specs/team-planner.spec.ts`      | 46           | Station startup, browsing/search/sorting, game Pokedex filters, manual/meta/random/champion team building, battle-format legality, duplicate handling, forms, abilities, natures, moves, assistant scoring/recommendations including swap preview and undo, matchup/stat analysis, navigation, and reliability checks |
...
| TrainerDex            | `tests/specs/trainerdex.spec.ts`        | 22           | Station startup, trainer search, region, game-version and battle-stage selection including Legends Z-A, trainer detail panels, team Pokemon TCG-card modal behavior, image fallback, delayed data, and rapid action reliability                                                                                       |
