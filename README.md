...
| Pokemon TCG Simulator | `tests/specs/tcg-simulator.spec.ts`     | 45           | Session startup, pack opening, pack modal behavior, binder progress, collection clearing, binder rarity sorting, set selection, Special / Limited reference sets, set filtering/sorting, and Pokemon/card search              |
