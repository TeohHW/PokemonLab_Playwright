...
| --------------------- | --------------------------------------- | ------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Shared app shell      | `tests/specs/application-shell.spec.ts` | 8            | Hash-route continuity, browser Back/Forward, single-station Continue context and parameter restoration, invalid Continue-state handling, far-right Resume alignment, absence of empty/favorites panels, SVG favicon delivery, station-menu navigation, scroll lock, initial-action focus, active-station styling, focus recovery and trapping, focus restoration, and persisted reduced-motion preference                                                                                       |
| Pokemon Pokedex       | `tests/specs/pokedex.spec.ts`           | 48           | Direct-route and reload restoration, paged navigation, typeahead search and inline clearing, profiles, previous/next boundaries, comparison, ability/move dialogs, collapsible evolution/card/sprite sections, game Pokedex filters including Legends Z-A, sorting, random Pokemon, image fallback, sticky mobile Overview/Forms/Moves/Cards sections, preserved desktop details, and rapid-action reliability                                                                                  |
| Pokemon TCG Simulator | `tests/specs/tcg-simulator.spec.ts`     | 56           | Data-load Retry, set routes and reload restoration, paginated set/Pokemon search, collapsible eight-set expansion browsing, pack preparation, Skip/Reveal All, keyboard card reveals, binder ownership/latest-pull filters, progress and clearing, rarity sorting, artwork candidates, Special / Limited sets, ten-entry pull history, collection persistence, and persistent mobile pack actions                                                                                               |
...
| TrainerDex            | `tests/specs/trainerdex.spec.ts`        | 27           | Direct trainer/game/stage routes and reload restoration, invalid-route fallback, search, previous/next boundaries, region/game-version/battle-stage selection including Legends Z-A, trainer detail panels, six-stat team rows with shared desktop headings and nested type badges, pointer/keyboard TCG-card dialogs, sticky mobile Overview/Team/Cards sections, team carousel and typography, responsive filter controls, failed artwork removal, delayed data, and rapid-action reliability |
...
- Shared hash routing, direct links, browser history, single-station Continue context, and local preferences
