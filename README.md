...
| Pokemon TCG Simulator | `tests/specs/tcg-simulator.spec.ts`     | 47           | Session startup, pack opening, pack modal behavior, binder progress, collection clearing, bidirectional binder rarity sorting, unowned-card artwork display, set selection, Special / Limited reference sets, search, and responsive web/mobile layouts                                                                                      |
