...
| Pokemon TCG Simulator | `tests/specs/tcg-simulator.spec.ts`     | 57           | Fresh Base Set home entry, data-load Retry, set routes and reload restoration, paginated set/Pokemon search, collapsible expansion browsing, pack preparation, Skip/Reveal All, keyboard card reveals, binder ownership/latest-pull filters, progress and clearing, rarity sorting, artwork candidates, Special / Limited sets, ten-entry pull history, durable collection persistence, and persistent mobile pack actions                                                                                                                                                             |
