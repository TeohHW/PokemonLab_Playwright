...
| Pokemon Team Planner  | `tests/specs/team-planner.spec.ts`      | 53           | Fresh empty home entry, Resume-only saved-workspace restoration, durable twelve-entry named-team library, separate Build/Analysis workspaces, collapsed member options, browsing/search/sorting, game Pokedex filters, manual/meta/random/champion teams, battle-format legality, forms, abilities, natures, moves, assistant scoring/recommendations, mobile slot selection, six-slot desktop preservation, navigation, and reliability checks                                                                                                                                        |
