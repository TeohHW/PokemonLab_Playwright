...
| TrainerDex            | `tests/specs/trainerdex.spec.ts`        | 27           | Fresh default trainer/game/stage home entry, direct trainer routes and reload restoration, invalid-route fallback, search, previous/next boundaries, region/game-version/battle-stage selection including Legends Z-A, trainer detail panels, six-stat team rows with shared desktop headings and nested type badges, pointer/keyboard TCG-card dialogs, responsive sections and filters, failed artwork removal, delayed data, and rapid-action reliability                            |
